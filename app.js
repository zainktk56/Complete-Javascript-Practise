...
// let num=Number(prompt("Enter a Number fot it's table : "));

// for (let i = 1; i < 16; i++) {
//     const element = ` ${num} x ${i} = ${num*i}` ;
//     console.log(element)
// }
...
// let array=["apple","banana","orange","mango","strawbery"]
// for (let index = 0; index < array.length; index++) {
//     const element =`Element at index ${index} is ${array[index]}`;
//     console.log(element)
// }
...
// let getpara= document.getElementById("output");
...
// let getpara2=document.getElementById("reverse");

// for (let i = 10; i>=1; i--) {
//     const reverse_cont = i;
//     console.log(reverse_cont)
//     getpara2.innerHTML+=`${reverse_cont} `
// }

// let getpara3=document.getElementById("even");
// let getpara4=document.getElementById("odd")
// for (let i = 0;i<=10; i++) {
//    if (i%2==0){
//     getpara3.innerHTML+=` ${i}`
//    }
//    else{
//     getpara4.innerHTML+=` ${i}`
//    }
// }

// let getpara5 = document.getElementById("series");
// for (let i = 1; i <=21; i++) {
//     if(i%2==0){
...
// let array=['apple','pie','cookie','chips','patties']

// let user_inp=prompt("Welcom To ABC !\n What do you want to Order ?").toLowerCase();


// let index = array.indexOf(user_inp);
// if(index !== -1){
//     alert(`The ${user_inp} exist in our array at ${index}`)
// }
// else{
